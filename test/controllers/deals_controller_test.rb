...
class DealsControllerTest < ActionController::TestCase
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post :create, deal: { Description: @deal.Description, name: @deal.name, type: @deal.type, value: @deal.value }
    end
  ...
  test "should update deal" do
    patch :update, id: @deal, deal: { Description: @deal.Description, name: @deal.name, type: @deal.type, value: @deal.value }
    assert_redirected_to deal_path(assigns(:deal))
  end
